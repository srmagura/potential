...
class PsExtend:
    ...
    def do_extend_1_right(self, i, j):
        x, y = self.get_coord(i, j)
    ...
    def do_extend_2_right(self, i, j):
        R = self.R
        a = self.a
            ...
            for l in range(len(gamma)):
                ...
                if sid == 0:
                    ...
                    if etype == self.etypes['standard']:
                        ...
                        ext[l] = self.do_extend_1_left(i, j)
                    elif etype == self.etypes['right']:
                        ext[l] = self.do_extend_1_right(i, j)
